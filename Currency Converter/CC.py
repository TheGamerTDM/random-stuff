...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        self.date_label = Label(self,
                                text=f"100 Danish Crowns equals = {self.currency_converter.convert('DKK', 'USD', 100)} USD \n Date : {self.currency_converter.data['date']}",
        ...
        self.from_currency_variable.set("DKK")  # default value
        ...
        self.convert_button.place(x=210, y=120)
